...
export abstract class AbstractName implements Name {
    ...
    public clone(): Name {
        InvalidStateException.assert(!this.isEmpty(), "Kein Component vorhanden");
        let n = { ...this };
        MethodFailedException.assert(this.isNullOrUndefined(n));
        return n;
    }
    ...
    public asString(delimiter: string = this.delimiter): string {
        ...
        if(count > 0){
            ...
            MethodFailedException.assert(this.isNullOrUndefined(str));
            return str;
        }
        return "";
    }
    ...
    public getHashCode(): number {
        ...
        MethodFailedException.assert(this.isNullOrUndefined(hashCode));
        return hashCode;
    }
    ...
    public getDelimiterCharacter(): string {
        InvalidStateException.assert(this.isNullOrUndefined(this.delimiter));
    ...
    public concat(other: Name): Name {
        IllegalArgumentException.assert(this.isNullOrUndefined(other));
        let copy: Name = this.clone();
        let prevNo: number = this.getNoComponents();
        for(let i: number = 0; i < other.getNoComponents(); i++){
            copy.append(other.getComponent(i));
        }
        MethodFailedException.assert((this.getNoComponents() === prevNo+other.getNoComponents()), "Failed at concat, wrong length");
        return copy;
    }
    ...
    protected isNullOrUndefined(o: Object | null) {
